...
Por ejemplo, el día 16 de Marzo del 2023 corrí los tests, se generó **`TestResults_2023-03-16.txt`** en la carpeta `testresults`

```console
cat testresults/TestResults_2023-03-16.txt
